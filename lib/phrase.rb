...
require 'phrase/api/blocked_keys_api'
...
require 'phrase/api/term_base_api'
require 'phrase/api/term_base_translation_api'
require 'phrase/api/term_base_translations_api'
require 'phrase/api/terms_in_term_base_api'
