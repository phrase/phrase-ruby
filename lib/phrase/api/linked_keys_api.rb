...
module Phrase
  class LinkedKeysApi
    ...
    # @return [nil]
    def key_links_batch_destroy(account_id, key_links_batch_destroy_parameters, opts = {})
      data, _status_code, _headers = key_links_batch_destroy_with_http_info(account_id, key_links_batch_destroy_parameters, opts)
      data
    end
    ...
    def key_links_batch_destroy_with_http_info(account_id, key_links_batch_destroy_parameters, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LinkedKeysApi.key_links_batch_destroy ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling LinkedKeysApi.key_links_batch_destroy"
      end
      ...
      # resource path
      local_var_path = '/projects/{project_id}/keys/{id}/key_links'.sub('{' + 'account_id' + '}', CGI.escape(account_id.to_s))
    ...
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [KeyLink]
    def key_links_create(account_id, key_links_create_parameters, opts = {})
      data, _status_code, _headers = key_links_create_with_http_info(account_id, key_links_create_parameters, opts)
      data
    end
    ...
    def key_links_create_with_http_info(account_id, key_links_create_parameters, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LinkedKeysApi.key_links_create ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling LinkedKeysApi.key_links_create"
      end
    ...
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [nil]
    def key_links_destroy(account_id, child_key_id, opts = {})
      data, _status_code, _headers = key_links_destroy_with_http_info(account_id, child_key_id, opts)
      data
    end
    ...
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [Array<(Response, Integer, Hash)>] Response<(nil, response status code and response headers
    def key_links_destroy_with_http_info(account_id, child_key_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LinkedKeysApi.key_links_destroy ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling LinkedKeysApi.key_links_destroy"
      end
      ...
      # resource path
      local_var_path = '/projects/{project_id}/keys/{id}/key_links/{child_key_id}'.sub('{' + 'account_id' + '}', CGI.escape(account_id.to_s)).sub('{' + 'child_key_id' + '}', CGI.escape(child_key_id.to_s))
    ...
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [KeyLink]
    def key_links_index(account_id, opts = {})
      data, _status_code, _headers = key_links_index_with_http_info(account_id, opts)
      data
    end
    ...
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [Array<(Response<(KeyLink)>, Integer, Hash)>] Response<(KeyLink)> data, response status code and response headers
    def key_links_index_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LinkedKeysApi.key_links_index ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling LinkedKeysApi.key_links_index"
      end
      # resource path
      local_var_path = '/projects/{project_id}/keys/{id}/key_links'.sub('{' + 'account_id' + '}', CGI.escape(account_id.to_s))
