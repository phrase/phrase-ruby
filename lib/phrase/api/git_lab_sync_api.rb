...
module Phrase
  class GitLabSyncApi
    ...
    # @param id [String] ID
    # @param gitlab_sync_delete_parameters [GitlabSyncDeleteParameters] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [nil]
    def gitlab_sync_delete(id, gitlab_sync_delete_parameters, opts = {})
      gitlab_sync_delete_with_http_info(id, gitlab_sync_delete_parameters, opts)
      nil
    end
    ...
    def gitlab_sync_delete_with_http_info(id, gitlab_sync_delete_parameters, opts = {})
      ...
      # verify the required parameter 'gitlab_sync_delete_parameters' is set
      if @api_client.config.client_side_validation && gitlab_sync_delete_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'gitlab_sync_delete_parameters' when calling GitLabSyncApi.gitlab_sync_delete"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(gitlab_sync_delete_parameters) 
    ...
    # @param gitlab_sync_id [String] Gitlab Sync ID
    # @param gitlab_sync_history_parameters [GitlabSyncHistoryParameters] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @option opts [Integer] :page Page number
    # @option opts [Integer] :per_page allows you to specify a page size up to 100 items, 10 by default
    # @return [Array<GitlabSyncHistory>]
    def gitlab_sync_history(gitlab_sync_id, gitlab_sync_history_parameters, opts = {})
      data, _status_code, _headers = gitlab_sync_history_with_http_info(gitlab_sync_id, gitlab_sync_history_parameters, opts)
      data
    end
    ...
    def gitlab_sync_history_with_http_info(gitlab_sync_id, gitlab_sync_history_parameters, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'gitlab_sync_history_parameters' is set
      if @api_client.config.client_side_validation && gitlab_sync_history_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'gitlab_sync_history_parameters' when calling GitLabSyncApi.gitlab_sync_history"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(gitlab_sync_history_parameters) 
    ...
    def gitlab_sync_list_with_http_info(gitlab_sync_list_parameters, opts = {})
      ...
      # verify the required parameter 'gitlab_sync_list_parameters' is set
      if @api_client.config.client_side_validation && gitlab_sync_list_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'gitlab_sync_list_parameters' when calling GitLabSyncApi.gitlab_sync_list"
      end
      # resource path
    ...
    # @param id [String] ID
    # @param gitlab_sync_show_parameters [GitlabSyncShowParameters] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_phrase_app_otp Two-Factor-Authentication token (optional)
    # @return [GitlabSync]
    def gitlab_sync_show(id, gitlab_sync_show_parameters, opts = {})
      data, _status_code, _headers = gitlab_sync_show_with_http_info(id, gitlab_sync_show_parameters, opts)
      data
    end
    ...
    def gitlab_sync_show_with_http_info(id, gitlab_sync_show_parameters, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'gitlab_sync_show_parameters' is set
      if @api_client.config.client_side_validation && gitlab_sync_show_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'gitlab_sync_show_parameters' when calling GitLabSyncApi.gitlab_sync_show"
      end
      # resource path
      local_var_path = '/gitlab_syncs/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(gitlab_sync_show_parameters) 
    ...
    def gitlab_sync_update_with_http_info(id, gitlab_sync_update_parameters, opts = {})
      ...
      # verify the required parameter 'gitlab_sync_update_parameters' is set
      if @api_client.config.client_side_validation && gitlab_sync_update_parameters.nil?
        fail ArgumentError, "Missing the required parameter 'gitlab_sync_update_parameters' when calling GitLabSyncApi.gitlab_sync_update"
      end
      # resource path
      local_var_path = '/gitlab_syncs/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
