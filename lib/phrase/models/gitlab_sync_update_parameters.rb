...
module Phrase
  class GitlabSyncUpdateParameters
    ...
    attr_accessor :phrase_project_code
    ...
    def self.attribute_map
      {
        ...
        :'phrase_project_code' => :'phrase_project_code',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Phrase::GitlabSyncUpdateParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Phrase::GitlabSyncUpdateParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'phrase_project_code')
        self.phrase_project_code = attributes[:'phrase_project_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          phrase_project_code == o.phrase_project_code &&
    ...
    def hash
      [account_id, phrase_project_code, gitlab_project_id, gitlab_branch_name].hash
    end
