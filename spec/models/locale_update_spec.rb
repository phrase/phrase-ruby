...
# Unit tests for Phrase::LocaleUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LocaleUpdate' do
  before do
    # run before each test
    @instance = Phrase::LocaleUpdate.new
  end
  ...
  describe 'test an instance of LocaleUpdate' do
    it 'should create an instance of LocaleUpdate' do
      expect(@instance).to be_instance_of(Phrase::LocaleUpdate)
    end
  end
