...
# Unit tests for Phrase::UploadCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UploadCreate' do
  before do
    # run before each test
    @instance = Phrase::UploadCreate.new
  end
  ...
  describe 'test an instance of UploadCreate' do
    it 'should create an instance of UploadCreate' do
      expect(@instance).to be_instance_of(Phrase::UploadCreate)
    end
  end
