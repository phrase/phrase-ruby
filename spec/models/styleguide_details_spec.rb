...
# Unit tests for Phrase::StyleguideDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StyleguideDetails' do
  before do
    # run before each test
    @instance = Phrase::StyleguideDetails.new
  end
  ...
  describe 'test an instance of StyleguideDetails' do
    it 'should create an instance of StyleguideDetails' do
      expect(@instance).to be_instance_of(Phrase::StyleguideDetails)
    end
  end
