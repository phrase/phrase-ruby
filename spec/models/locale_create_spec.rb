...
# Unit tests for Phrase::LocaleCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LocaleCreate' do
  before do
    # run before each test
    @instance = Phrase::LocaleCreate.new
  end
  ...
  describe 'test an instance of LocaleCreate' do
    it 'should create an instance of LocaleCreate' do
      expect(@instance).to be_instance_of(Phrase::LocaleCreate)
    end
  end
