...
# Unit tests for Phrase::StyleguideCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StyleguideCreate' do
  before do
    # run before each test
    @instance = Phrase::StyleguideCreate.new
  end
  ...
  describe 'test an instance of StyleguideCreate' do
    it 'should create an instance of StyleguideCreate' do
      expect(@instance).to be_instance_of(Phrase::StyleguideCreate)
    end
  end
