...
# Unit tests for Phrase::StyleguideUpdateParameters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StyleguideUpdateParameters' do
  before do
    # run before each test
    @instance = Phrase::StyleguideUpdateParameters.new
  end
  ...
  describe 'test an instance of StyleguideUpdateParameters' do
    it 'should create an instance of StyleguideUpdateParameters' do
      expect(@instance).to be_instance_of(Phrase::StyleguideUpdateParameters)
    end
  end
