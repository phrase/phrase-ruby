...
# Unit tests for Phrase::ChangesVersionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ChangesVersionsApi' do
  before do
  ...
  describe 'test an instance of ChangesVersionsApi' do
    it 'should create an instance of ChangesVersionsApi' do
      expect(@api_instance).to be_instance_of(Phrase::ChangesVersionsApi)
    end
  end
