...
# Unit tests for Phrase::TermsInTermBaseApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TermsInTermBaseApi' do
  before do
  ...
  describe 'test an instance of TermsInTermBaseApi' do
    it 'should create an instance of TermsInTermBaseApi' do
      expect(@api_instance).to be_instance_of(Phrase::TermsInTermBaseApi)
    end
  end
