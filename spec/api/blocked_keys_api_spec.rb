...
# Unit tests for Phrase::BlockedKeysApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BlockedKeysApi' do
  before do
  ...
  describe 'test an instance of BlockedKeysApi' do
    it 'should create an instance of BlockedKeysApi' do
      expect(@api_instance).to be_instance_of(Phrase::BlockedKeysApi)
    end
  end
