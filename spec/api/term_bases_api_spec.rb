...
# Unit tests for Phrase::TermBasesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TermBasesApi' do
  before do
  ...
  describe 'test an instance of TermBasesApi' do
    it 'should create an instance of TermBasesApi' do
      expect(@api_instance).to be_instance_of(Phrase::TermBasesApi)
    end
  end
